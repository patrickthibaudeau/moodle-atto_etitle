YUI.add('moodle-atto_etitle-button', function (Y, NAME) {
...
/**
 * @module moodle-atto_etitle-button
 */
...
Y.namespace('M.atto_etitle').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    /**
     * Change the etitle to the specified style.
     *
     * @method _changeStyle
     * @param {EventFacade} e
